...
DROP POLICY IF EXISTS "Allow full access on products to service role / admin" ON public.products;
...
DROP POLICY IF EXISTS "Allow public read/write on admins" ON public.admins;
